...
function nasPayment() {
  ...
  var hash = document.getElementById('contentDistributionWidget').getAttribute("data-wallet"); 

  var to = dappAddress;
  var amount = document.getElementById('contentDistributionWidget').getAttribute("data-price");
  var value = parseFloat(amount);
  var callFunction = "download";
  var callArgs = "[\"" + hash + "\"]";

  txHash = nebPay.call(to, value, callFunction, callArgs, {
    callback: endpoint
  });
  intervalQuery = setInterval(function() {
      intervalQueryFn(endpoint);
  }, 20000);
}
...
function intervalQueryFn(endpoint) {
...
function modalExtension() { 
  alert("Nebulas Web Extension Wallet is not installed\n\nPlease follow the instructions at https://github.com/ChengOrangeJu/WebExtensionWallet");
}

function generateWidgetHtml() {
  var html = '<div id="widget">\
    <p class="title">'+document.getElementById('contentDistributionWidget').getAttribute("data-title")+'</p>\
    <p class="introduction">'+document.getElementById('contentDistributionWidget').getAttribute("data-introduction")+'</p>\
    <a class="button button-primary u-full-width buy" href="#" onclick="nasPayment();">Buy for <span id="nasPrice">'+document.getElementById('contentDistributionWidget').getAttribute("data-price")+'</span> NAS</a>\
    <p class="u-pull-right"><a href="https://nebulas.io/" target="_blank"><img src="https://shuffledex.github.io/ContentDistributionWidget/images/nebulas.png" style="width:75px" /></a></p>\
  </div>';
  var font = "<link href='https://fonts.googleapis.com/css?family=Raleway:400,300,600' rel='stylesheet' type='text/css'>"
  var css = "#widget{background-color:#fff;border-radius:12px;padding:24px 24px 34px;font-size:1.5em;line-height:1.6;font-weight:400;font-family:Raleway,HelveticaNeue,\"Helvetica Neue\",Helvetica,Arial,sans-serif;color:#222;width:300px;text-align:center}#widget .introduction,#widget .title{color:grey;padding:0;margin:0}#widget .introduction{font-size:15px}#widget .title{font-size:22px;text-transform:uppercase;font-weight:600}.button.button-primary,.button.button-primary:active,.button.button-primary:hover,.button.button-primary:link,.button.button-primary:visited{background-color:#F35E51;border-color:#F35E51}.button.button-primary,button.button-primary,input[type=button].button-primary,input[type=reset].button-primary,input[type=submit].button-primary{color:#FFF}.buy{box-shadow:0 2px 10px #CCC;margin-top:12px}.button{border-radius:24px}.u-full-width{width:100%;box-sizing:border-box}.button,button{margin-bottom:1rem}.button,button,input[type=button],input[type=reset],input[type=submit]{display:inline-block;height:38px;padding:0 30px;text-align:center;font-size:11px;font-weight:600;line-height:38px;letter-spacing:.1rem;text-transform:uppercase;text-decoration:none;white-space:nowrap;border:1px solid #bbb;cursor:pointer}.u-pull-right{float:right}";
  html += font + '<style>' + css + '</style>';
  return html;
}